...
- **Vertex AI Training**: First Docker push will take 15-20 minutes (~7.6GB PyTorch+CUDA base image). Subsequent pushes are fast (~1-2 minutes) since only code changes are uploaded.
